...
{\small nebularesearchlab@gmail.com\par}
\end{center}
...
\textbf{Layer A — empirical orbital-element inputs.}  
...
\textbf{Layer B — constructed interaction graph.}  
...
\textbf{Layer C — simulated protocol outputs.}  
...
\begin{itemize}[leftmargin=*]
\item \texttt{https://celestrak.org/NORAD/elements/gp.php?GROUP=iridium-NEXT\&FORMAT=json}
\item \texttt{https://celestrak.org/NORAD/elements/gp.php?GROUP=oneweb\&FORMAT=json}
\item \texttt{https://celestrak.org/NORAD/elements/gp.php?GROUP=starlink\&FORMAT=json}
...
No additional discussion figure was included. The calibration roadmap is summarized in prose as: structural parity established -> bounded-horizon non-convergence observed -> future sensitivity analysis over horizon, thresholds, edge-weight construction, initialization, and graph assumptions.
...
No additional industry-facing figure was included. The staged adoption logic is summarized in prose as: calibration -> advisory or shadow-mode use -> gated operational use only after reproducible convergence evidence and assurance review.
